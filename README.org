#+TITLE:  My NixOS and Emacs configuration
...
:END:
Disko is available in [[https://github.com/NixOS/nixpkgs][nixpkgs]], but
it is advisable to run the latest commit from the
[[https://github.com/nix-community/disko][nix-community]] repo. Make
sure the =disko-config.nix= belongs to the correct host. By default,
it's set for [[./modules/nixosModules/hosts/nixpavilion/][nixpavilion]].
...
- [[https://github.com/krishna4a6av/Wallpapers][Wallpapers Repo]] by
  krishna4a6av.
- [[https://github.com/rothgar/awesome-tuis][Awesome TUIs]] for the
  terminally addicted.
- [[https://diataxis.fr/][Diataxis]] Method is a great method to write documents.
